...
<span style = 'font-size: 85%;'>`r fontawesome::fa("angle-right", fill = "#5D7E6A", a11y = "sem")` 11-month professional master's program administered by Bren in partnership with NCEAS</span>  
<br>
<span style = 'font-size: 85%;'>`r fontawesome::fa("angle-right", fill = "#5D7E6A", a11y = "sem")` </span>  
<br>

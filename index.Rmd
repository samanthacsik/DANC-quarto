...
You can follow along by opening up RStudio on your own computer, or check out the following slides, which detail some of what I'll demonstrate. You can also reference the [quarto_key.qmd]() file, which includes examples of all the features we'll cover today. 
